...
LIST_FILE_NAME = 'LIVE_VQA.txt'
ALL_SCENES = list(range(10))
ALL_DIST_TYPES = list(range(5)) #including reference
...
def make_image_list(scenes, dist_types=None, show_info=True):
    ...
    dist_names = ['ref', 'Wireless', 'Distortions', 'H.264', 'MPEG']
    # Distortion Types
    # 0 = ref
    # 1 = Wireless
    # 2 = Distortions
    # 3 = H.264 Compression
    # 4 = MPEG - 2 Compression
